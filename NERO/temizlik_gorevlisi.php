...
<h2>Temizlik Personeli Update
            ...
            <div class="contact-col">
     <form method="POST" action="temizlik_gorevlisi_update.php" enctype="multipart/form-data">

        <label for="temizlik_personeli_id"><b>ID:</b></label>
        <input type="number" name="temizlik_personeli_id" id="temizlik_personeli_id" placeholder="Lütfen ID giriniz" required value=0>
        <br>

        <label for=""><b>Temizlik Personel Id filtre:</b></label>
        ...
        <label for="yeni_çalışma_durumu"><b>Yeni Çalışma Durumu:</b></label>
