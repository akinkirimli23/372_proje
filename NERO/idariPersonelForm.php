...
$idari_personel_id_filtre = $_POST['idari_personel_id_filtre'];
$isim = $_POST['isim'];
...
$where = "  ";
$x = 0;
if($idari_personel_id != 0){
    $where .= " WHERE ";
    $where .= "idari_personel_id $idari_personel_id_filtre $idari_personel_id";
    $x++;
}
...
$sql = "SELECT * FROM idari_personel" .  "$where;";
