...
if (isset($_GET['idari_personel_id'])) {
    ...
    echo "Selected idari personel ID: " . $idari_personel_id;
} else {
...
$sql = "SELECT *
        FROM idari_personel
        JOIN parttimeidari_personel_gün_ve_saat ON idari_personel.idari_personel_id = parttimeidari_personel_gün_ve_saat.idari_personel_id  
        WHERE idari_personel.idari_personel_id  = '$idari_personel_id';";
